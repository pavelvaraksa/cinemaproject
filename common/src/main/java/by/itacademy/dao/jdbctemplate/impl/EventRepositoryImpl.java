...
public class EventRepositoryImpl implements EventRepository {
    ...
    private Event getEventRowMapper(ResultSet rs, int i) throws SQLException {
        ...
        event.setDate(rs.getString(EventColumn.DATE));
        event.setTime(rs.getString(EventColumn.TIME));
        event.setTicketsCount(rs.getInt(EventColumn.TICKETS_COUNT));
    ...
    public Event save(Event event) {
        final String createQuery = "insert into m_event (date, time, tickets_count, created, changed, movie_id, cinema_id) " +
                "values (:date, :time, ticketsCount, :created, :changed, :movieId, :cinemaId);";
        ...
        params.addValue("ticketsCount", event.getTicketsCount());
